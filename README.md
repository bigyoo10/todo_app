...
- **APK 다운로드**: [todo_app_v1.0.0.apk](https://github.com/bigyoo10/todo_app/releases/tag/v1.0.0/app-release.apk)
...
|--------------|-------------|
| ![Splash](screenshots/splash.png) | ![Add Task](screenshots/add_task.png) |
